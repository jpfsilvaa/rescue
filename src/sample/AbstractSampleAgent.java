...
public abstract class AbstractSampleAgent<E extends StandardEntity> extends StandardAgent<E> {
    ...
    protected static ArrayList<Crenca> crencas = new ArrayList<Crenca>();
    protected static HashMap<Integer, int[]> paths = new HashMap<Integer, int[]>();
    //QUANDO OS CENTROS FOREM ADICIONADOS A SIMULAÇÃO, ESTES 3 ATRIBUTOS SEGUINTES SERÃO DE CADA CENTRO E NÃO DAQUI
    protected static Eventos ambEvents = new Eventos('c');
    protected static Eventos fireEvents = new Eventos('f');
    protected static Eventos polEvents = new Eventos('b');
    ...
    */
    ...
    protected void patrulhar(int time){};
